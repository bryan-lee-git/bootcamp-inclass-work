...
// for each array index, if the next index/number is less than the current index/number, move it behind the index it was checked against, continue to move it backward until it is greater than the index just before it
